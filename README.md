...
The web application **[Smart Brain](http://smartbrainaws.s3-website-us-east-1.amazonaws.com)** is the final project of the Udemy class [The Complete Web Developer in 2021: Zero to Mastery](https://www.udemy.com/course/the-complete-web-developer-zero-to-mastery/). The application is deployed currently on [AWS](https://aws.amazon.com/). In the class, the application is deployed on [Heroku](https://www.heroku.com/).
